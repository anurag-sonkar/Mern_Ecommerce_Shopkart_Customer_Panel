...
function Home() {
  ...
  if (isLoading) {
    return (
      <>
        {/* lg , md screen  */}
        <div className="lg:grid md:grid hidden grid-col-4 gap-5 place-items-center py-2 lg:px-5 px-2 ">
          ...
          {/* <div className="col-span-4 lg:hidden md:grid hidden">
            <Skeleton.Input
              active="true"
              block="false"
              ...
              {[...Array(4)].map((_, index) => (
                <div key={index}>
                  <Skeleton.Node
                    ...
                    className="hover:scale-105 transition-all ease-in-out 1s z-10"
                  >
                    <DotChartOutlined
                      style={{
                        fontSize: 40,
        ...
        {/* sm-screen*/}
        <div className="lg:hidden md:hidden grid grid-col-2 gap-5 place-items-center py-2 px-2 ">
          <div className="col-span-2">
            <Skeleton.Input
              active="true"
              block="false"
          ...
          <div className="col-span-2">
            <div className="grid grid-cols-2 gap-2 place-items-center">
              <div className="">
                <Skeleton.Node
                  active={active}
                  style={{ width: "168px", height: "140px" }}
                >
                  <DotChartOutlined
                    style={{
                      fontSize: 40,
  ...
  return (
    <div className="">
          ...
          >
            <div>
              <Link
                to={{
                  pathname: "/store",
                  search: "?type=category&value=grocery",
                }}
            ...
            <div>
              <Link
                to={{
                  pathname: "/store",
                  search: "?type=category&value=mobiles",
                }}
                className="grid place-items-center cursor-pointer"
              >
                <img
            ...
            <div>
              <Link
                to={{
                  pathname: "/store",
                  search: "?type=category&value=fashion",
                }}
                className="grid place-items-center cursor-pointer"
              >
                <img
            ...
            <div>
              <Link
                to={{
                  pathname: "/store",
                  search: "?type=category&value=electronics",
                }}
                className="grid place-items-center cursor-pointer"
              >
                <img
            ...
            <div>
              <Link
                to={{
                  pathname: "/store",
                  search: "?type=category&value=Home-Furniture",
                }}
                className="grid place-items-center cursor-pointer"
              >
                <img
                  src="/assets/home-and-furniture.webp"
                  className="object-contain lg:w-16 md:w-16 w-10 h-auto"
                />
                <div className="capitalize text-center font-semibold lg:text-sm md:text-sm text-xs">
                  home & furniture
            ...
            <div>
              <Link
                to={{
                  pathname: "/store",
                  search: "?type=category&value=appliances",
                }}
                className="grid place-items-center cursor-pointer"
              >
                <img
            ...
            <div>
              <Link
                to={{
                  pathname: "/store",
                  search: "?type=category&value=travel",
                }}
                className="grid place-items-center cursor-pointer"
              >
                <img
            ...
            <div>
              <Link
                to={{
                  pathname: "/store",
                  search: "?type=category&value=Beauty-Toy",
                }}
                className="grid place-items-center cursor-pointer"
              >
                <img
                  src="/assets/beauty-toys-and-more.webp"
                  className="object-contain lg:w-16 md:w-16 w-10 h-auto"
                />
                <div className="capitalize text-center font-semibold lg:text-sm md:text-sm text-xs">
                  beauty,toys & more
            ...
            <div>
              <Link
                to={{
                  pathname: "/store",
                  search: "?type=category&value=Two-Wheelers",
                }}
                className="grid place-items-center cursor-pointer"
              >
                <img
                  src="/assets/two-wheelers.webp"
                  className="object-contain lg:w-16 md:w-16 w-10 h-auto"
                />
                <div className="capitalize text-center font-semibold lg:text-sm md:text-sm text-xs">
                  two-wheelers
      ...
      {/* first section */}
      <section className="grid grid-cols-4 grid-rows-2 place-items-center gap-2 lg:px-8 md:px-8 px-2 py-2 lg:grid-flow-col grid-flow-row">
      ...
      {/* <section className="h-fit w-full bg-gray-200 lg:px-10">
          <div className="w-full bg-white  rounded-lg px-6 py-10 grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 lg:grid-rows-2 md:grid-rows-5 grid-rows-10 gap-2">
            <div className="shadow-md hover:shadow-lg rounded-sm flex items-center justify-center pl-2 py-7 min-w-56 gap-2 cursor-pointer">
              ...
              <img src="/assets/laptop.jpg" className="w-16 h-auto" />
            </div>
            ...
            <div className="shadow-md hover:shadow-lg rounded-sm flex items-center justify-center pl-2 py-4 min-w-56 gap-2 cursor-pointer">
              ...
              <img src="/assets/camera.jpg" className="w-16 h-auto" />
            </div>
            <div className="shadow-md hover:shadow-lg rounded-sm flex items-center justify-center pl-2 py-7 min-w-56 gap-2 cursor-pointer">
              <div className="capitalize ">
                <p className="font-semibold lg:text-sm min-w-36">
      ...
      <section className="bg-[#EEEEEE] py-16 px-0 shadow-2xl">
        ...
        >
          <img className="mx-10 w-28 h-auto" src="/assets/brand-01.png" />
          <img className="mx-10 w-28 h-auto" src="/assets/brand-02.png" />
          <img className="mx-10 w-28 h-auto" src="/assets/brand-03.png" />
          <img className="mx-10 w-28 h-auto" src="/assets/brand-04.png" />
          <img className="mx-10 w-28 h-auto" src="/assets/brand-05.png" />
          <img className="mx-10 w-28 h-auto" src="/assets/brand-06.png" />
          <img className="mx-10 w-28 h-auto" src="/assets/brand-07.png" />
          <img className="mx-10 w-28 h-auto" src="/assets/brand-08.png" />
        </Marquee>
      </section>
